            ...
            <div class="Z_about_features ">
               <div class="Z_about_feature">
                  <div class="Z_about_icon">
                     <img src="{{ asset('frontend/images/inner-icon-img-1.png') }}" alt="Feature 1" class="Z_about_img" />
                  </div>
               ...
               <div class="Z_about_feature">
                  <div class="Z_about_icon">
                     <img src="{{ asset('frontend/images/inner-icon-img-2.png') }}" alt="Feature 2" class="Z_about_img" />
                  </div>
                  <div class="Z_about_feature-content">
      ...
      <div class="container my-5">
         <div class="Z_about_split-container">
            <div class="Z_about_split-left">
               <img src="{{ asset('frontend/images/port-standard.jpg') }}" alt="Angel Warrior" class="Z_about_split-img" />
            </div>
            <div class="Z_about_split-right">
               ...
               <div class="Z_about_split-features">
                  <div class="Z_about_split-feature">
                     <img src="{{ asset('frontend/images/inner-icon-img-3.png') }}" alt="Feature 1" class="Z_about_split-icon" />
                  ...
                  <div class="Z_about_split-feature">
                     <img src="{{ asset('frontend/images/inner-icon-img-4.png') }}" alt="Feature 2" class="Z_about_split-icon" />
                     <span class="Z_about_split-feature-text">Lorem ipsum dolor sit amet, consectetur adipiscing
                     elit. Maecenas tempus, mauris eget sagittis.</span>
                  </div>
               </div>
            ...
            <div class="swiper Z_about_swiper">
               <div class="swiper-wrapper">
                  <div class="swiper-slide">
                     <div class="Z_about_card">
                        <div class="Z_about_testimonial-content">
                           <img src="{{ asset('frontend/images/Profile11.jpeg') }}" alt="Brotherhood in Battle"
                              class="Z_about_card_img">
                           <div class="Z_about_card_body">
                              <h3 class="Z_about_card_title">Brotherhood in Battle</h3>
                              <p class="Z_about_card_desc">Joining this clan turned every match into an
                                 adventure. The teamwork and support here are unmatched!
                              </p>
                  ...
                  <div class="swiper-slide">
                     <div class="Z_about_card">
                        <div class="Z_about_testimonial-content">
                           <img src="{{ asset('frontend/images/Profile22.jpeg') }}" alt="Victory & Growth" class="Z_about_card_img">
                           <div class="Z_about_card_body">
                              <h3 class="Z_about_card_title">Victory & Growth</h3>
                              <p class="Z_about_card_desc">I've improved my skills and made lifelong friends.
                                 Every win feels like a shared triumph.
                              </p>
                              <button class="Z_about_card_btn">Learn More</button>
                           </div>
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="Z_about_card">
                        <div class="Z_about_testimonial-content">
                           <img src="{{ asset('frontend/images/Profile33.jpeg') }}" alt="Unbreakable Bonds" class="Z_about_card_img">
                           <div class="Z_about_card_body">
                              <h3 class="Z_about_card_title">Unbreakable Bonds</h3>
                              <p class="Z_about_card_desc">We celebrate victories and learn from defeats
                                 together. This clan is my second family.
                              </p>
                              <button class="Z_about_card_btn">Learn More</button>
                           </div>
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="Z_about_card">
                        <div class="Z_about_testimonial-content">
                           <img src="{{ asset('frontend/images/Profile11.jpeg') }}" alt="Always Ready" class="Z_about_card_img">
                           <div class="Z_about_card_body">
                              <h3 class="Z_about_card_title">Always Ready</h3>
                              <p class="Z_about_card_desc">No matter the challenge, someone's always got your
                                 back. That's what makes us strong.
                              </p>
                              <button class="Z_about_card_btn">Learn More</button>
                           </div>
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="Z_about_card">
                        <div class="Z_about_testimonial-content">
                           <img src="{{ asset('frontend/images/Profile22.jpeg') }}" alt="Fun & Friendship" class="Z_about_card_img">
                           <div class="Z_about_card_body">
                              <h3 class="Z_about_card_title">Fun & Friendship</h3>
                              <p class="Z_about_card_desc">It's not just about the games—it's about the
                                 laughs, the late nights, and the memories we create.
                              </p>
                              <button class="Z_about_card_btn">Learn More</button>
                           </div>
                        </div>
