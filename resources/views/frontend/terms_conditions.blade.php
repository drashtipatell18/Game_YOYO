                ...
                <div class="x_privacy-content bg-opacity-75 p-4">
                    <ul class="list-unstyled">
                        <li><strong>Agreement to Terms:</strong>
                            <ul>
                                <li>By visiting or using the YOYO Khel website, you acknowledge and agree to comply with
                        ...
                        <li><strong>User Eligibility:</strong>
                            <ul>
                                ...
                                <li>Users under the age of 18 should review these terms with a parent or guardian before
                        ...
                        <li><strong>Acceptable Use Policy:</strong>
                            <ul>
                                <li>Do not engage in cheating, hacking, or using unauthorized tools that give unfair
                                    advantages.</li>
                                <li>Treat others respectfully—any form of bullying, offensive language, or harassment is
