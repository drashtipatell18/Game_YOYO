      ...
      <div class="container">
        <div class="row form-box rounded-4 overflow-hidden">
          ...
          <div class="col-lg-6 col-md-6 d-none d-md-flex justify-content-center align-items-end img-part">
            <img src="{{ asset('frontend/images/login.webp')}}" alt="robot" class="img-fluid robot-img" />
          </div>
              ...
              <form>
                ...
                <div class="d-flex justify-content-center gap-4 mb-3 social-icons">
                  <div class="google icon">
                    <img src="{{ asset('frontend/images/google-logo.png')}}" alt="Google" width="25" />
                  </div>
                  <div class="apple icon">
                    <img src="{{ asset('frontend/images/apple-logo.png')}}" alt="Apple" width="20" />
                  </div>
                  <div class="facebook icon">
                    <img src="{{ asset('frontend/images/Facebook-logo.png')}}" alt="Facebook" width="25" />
                  </div>
                </div>
